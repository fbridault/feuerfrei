...
#ifdef MULTITHREADS
GlobalField::GlobalField(const list <FieldThread *> &threads, CScene* const scene, char type, uint n,
#else
GlobalField::GlobalField(const vector <Field3D *> &fields, CScene* const scene, char type, uint n,
#endif
