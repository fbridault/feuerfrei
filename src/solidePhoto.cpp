...
SolidePhotometrique::SolidePhotometrique(CScene *s, CGcontext *context) :
  SPVertexShaderTex("SolidePhotometriqueVP.cg","vpSPTEX",context),
  SPVertexShaderWTex("SolidePhotometriqueVP.cg","vpSPWTEX",context)
{
  scene = s;
  ...
  SPFragmentShader[0] = new CgSPFragmentShader("SolidePhotometriqueFP.cg","fpSPSeul",context,&ieslist,0);
  SPFragmentShader[1] = new CgSPFragmentShader("SolidePhotometriqueFP.cg","fpSPSeulInterpole",context,&ieslist,1);
  SPFragmentShader[2] = new CgSPFragmentShader("SolidePhotometriqueFP.cg","fpSPTEX",context,&ieslist,0);
  SPFragmentShader[3] = new CgSPFragmentShader("SolidePhotometriqueFP.cg","fpSPTestTEX",context,&ieslist,1);
  SPFragmentShader[4] = new CgSPFragmentShader("SolidePhotometriqueFP.cg","fpSPWTEX",context,&ieslist,0);
  SPFragmentShader[5] = new CgSPFragmentShader("SolidePhotometriqueFP.cg","fpSPTestWTEX",context,&ieslist,1);
}
...
void
SolidePhotometrique::calculerFluctuationIntensiteCentreEtOrientation(CVector o,CPoint* p)
{
  float r,y;
