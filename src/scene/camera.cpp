...
void Camera::getScreenCoordinates(const CPoint& objPos, CPoint& screenPos) const
{
  double pos[3];
...
void Camera::getSphereCoordinates(const CPoint& objPos, float radius, CPoint& centerScreenPos, CPoint& periScreenPos ) const
{
  CPoint up, tmp;
