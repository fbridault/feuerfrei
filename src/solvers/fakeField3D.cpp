                                  ...
                                  const CPoint& TRStrength, const CPoint& BRStrength)
{
	...
	{
		case LEFT_FACE :
			m_temporaryExternalForces.x -= 5*(BLStrength.x+TLStrength.x+TRStrength.x+BRStrength.x)/4.0f;
			break;
		case RIGHT_FACE :
			m_temporaryExternalForces.x -= 5*(BLStrength.x+TLStrength.x+TRStrength.x+BRStrength.x)/4.0f;
			break;
		case BACK_FACE :
			m_temporaryExternalForces.z -= 5*(BLStrength.z+TLStrength.z+TRStrength.z+BRStrength.z)/4.0f;
			break;
		case FRONT_FACE :
			m_temporaryExternalForces.z -= 5*(BLStrength.z+TLStrength.z+TRStrength.z+BRStrength.z)/4.0f;
			break;
