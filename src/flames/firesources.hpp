...
public:
   ...
   */
  Candle(Solver * s, CPoint& posRel, CScene *scene, double innerForce,  const char *filename, 
...
public:
   ...
   * @param nbSkeletons nombre de squelettes périphériques
   */
  Firmalampe(Solver * s, CPoint& posRel, CScene *scene, double innerForce,  const char *filename, 
